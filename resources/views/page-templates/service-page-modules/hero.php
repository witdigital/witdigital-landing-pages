		...
		<div class="mt-3 text-center text-white servicesHeroCall laptop:mt-6">
			...
			<div class="flex items-center justify-between mx-auto my-0 phoneBtns flex-nowrap max-w-340">
				<div class="phoneBtnItem mb-2.5">
					...
					<a href="tel:<?php echo $wlp_phone_1_href?>" class="px-3 py-2 text-base font-bold bg-white rounded-md phoneBtn btn"><img class="w-3.5 align-middle iconImage phoneBtnImage" src="<?php echo $wlp_call_button_icon?>" /> <span class=""><?php echo $wlp_phone_1_display ?></span></a>
				</div>
				...
				<div class="phoneBtnItem mb-2.5">
					...
					<a href="tel:<?php echo $wlp_phone_2_href?>" class="px-3 py-2 text-base font-bold bg-white rounded-md phoneBtn btn"><img class="w-3.5 align-middle iconImage phoneBtnImage" src="<?php echo $wlp_call_button_icon?>" /> <span class=""><?php echo $wlp_phone_2_display ?></span></a>
				</div>
				<?php endif; ?>
