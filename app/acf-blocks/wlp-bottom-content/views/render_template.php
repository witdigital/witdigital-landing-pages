...
/*  ==========================================================================
    ...
    * Description: Front end for the WLP Bottom Content block
    * Author: edawson1980
    *
...
$wlp_coupon_title = (get_field('witlandingpages_coupon_title')) ? get_field('witlandingpages_coupon_title') : '' ;
$wlp_coupon_subtitle = (get_field('witlandingpages_coupon_subtitle')) ? get_field('witlandingpages_coupon_subtitle') : '' ;
$wlp_coupon_image = (get_field('witlandingpages_coupon_image')) ? get_field('witlandingpages_coupon_image')['url'] : '' ;
$wlp_locations_url = (get_field('witlandingpages_locations_url')) ? get_field('witlandingpages_locations_url') : '' ;
$wlp_locations_button = (get_field('witlandingpages_locations_button')) ? get_field('witlandingpages_locations_button') : '' ;
...
?>
    ...
    <div id="<?php echo $blockID ?>" class="<?php echo esc_attr( $className ); ?> alignfull">
        ...
        <div class="wlpBottomContent_wrapper">
                                ...
                                <div class="relative mb-5 servicesContentSidebarSection sidebarCouponSection">
                                    <div class="text-center sidebarCouponSectionInner sidebarSectionInner bg-blue rounded-2xl">
                                        <div class="absolute z-10 couponBorder rounded-2xl"></div>
                                            <div class="h-48 rounded-tr-2xl rounded-tl-2xl" style="background: url(<?php echo $wlp_coupon_image ?>) center / cover;"></div>
                                            <div class="z-20 p-4 rounded-br-2xl rounded-bl-2xl">
                                                <h3 class="text-white couponSidebarTitle"><?php echo $wlp_coupon_title; ?></h3>
                                                <div class="text-white couponSidebarText"><?php echo $wlp_coupon_subtitle; ?></div>
            ...
            </div> <!-- End of .wlpBottomContent_inner -->

        </div> <!-- End of .wlpBottomContent_wrapper -->
