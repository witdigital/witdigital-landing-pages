...
function witlandingpages_one_phone( $atts ) {
    ...
    <div class="flex items-center justify-center mx-auto my-0 phoneBtns flex-nowrap max-w-340">
        <div class="phoneBtnItem mb-2.5 mt-8">
            ...
            <a href="tel:<?php echo $wlp_phone_1_href ?>"
               class="px-8 py-2 text-base font-bold phoneBtn btn customPhone <?php echo $wlp_phone_png_svg ?> ">

				<?php else: ?>
                <!-- for default icon: -->

                <a href="tel:<?php echo $wlp_phone_1_href ?>"
                   class="px-8 py-2 text-base font-bold phoneBtn btn defaultPhone">
...
function witlandingpages_two_phones( $atts ) {
    ...
    <style>
        ...
        <?php echo $wlp_styles_phone_location_color ?> margin-bottom: 0.375rem;
        }
        ...
        <?php echo $wlp_styles_phone_png ?> filter: unset;
        }

        .pngPhone.phoneBtnTwo .phoneBtnBody:hover:before {
        <?php echo $wlp_styles_phone_png_hvr ?> filter: unset;
        }
        ...
        <?php echo $wlp_styles_phone_svg_hvr ?><?php echo $wlp_styles_phone_custom_hvr ?>
        }
        ...
        <div class="phoneBtnItemTwo mb-2.5">
            ...
            <a href="tel:<?php echo $wlp_phone_1_href ?>"
               class="px-4 laptop:px-8 py-2 text-base font-bold phoneBtnTwo btn customPhone <?php echo $wlp_phone_png_svg ?> ">
                ...
                <a href="tel:<?php echo $wlp_phone_1_href ?>"
                   class="px-4 py-2 text-base font-bold laptop:px-8 phoneBtnTwo btn defaultPhone">
...
function witlandingpages_schedule_btn( $atts ) {
    ...
    <style>
        ...
        .reqBtn {
        <?php echo $wlp_styles_req_bkgnd ?><?php echo $wlp_styles_req_rad ?>
        }

        /* default calendar icon */
        .reqBtnBody:before {
            content: "";
        <?php echo $wlp_style_req_btn ?> position: absolute;
            left: 25px;
            /* left: 94px; */
            width: 17px;
            height: 19px;
        ...
        <?php echo $wlp_styles_req_png ?> filter: unset;
        }

        .pngReq .reqBtnBody:hover:before {
        <?php echo $wlp_styles_req_png_hvr ?> filter: unset;
        }

        /* custom calendar SVG */
        .svgReq .reqBtnBody:before {
        <?php echo $wlp_styles_req_svg ?><?php echo $wlp_styles_req_custom_filter ?>
        }

        .svgReq .reqBtnBody:hover:before {
        <?php echo $wlp_styles_req_svg_hvr ?><?php echo $wlp_styles_req_custom_hvr ?>
        }
    ...
    <div class="flex items-center justify-start mx-auto my-0 phoneBtns reqBtns flex-nowrap max-w-340">
        <div class="requestButton">
            ...
            <a class="px-6 py-2 text-base font-bold uppercase bg-white rounded-md laptop:px-8 reqBtn btn customReq <?php echo $wlp_req_png_svg ?>"
               href="<?php echo $wlp_req_btn_url ?>">


				<?php else: ?>
                <!-- for default icon: -->

                <a class="px-6 py-2 text-base font-bold uppercase bg-white rounded-md laptop:px-8 reqBtn btn defaultReq"
                   href="<?php echo $wlp_req_btn_url ?>">
